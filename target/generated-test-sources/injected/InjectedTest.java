...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:checks-api:0.1.1-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","/Users/kezhi/dev/jenkins/checks-api-plugin");
    parameters.put("artifactId","checks-api");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","/Users/kezhi/dev/jenkins/checks-api-plugin/target/classes");
    parameters.put("testOutputDirectory","/Users/kezhi/dev/jenkins/checks-api-plugin/target/test-classes");
